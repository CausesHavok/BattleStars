...
public class RectangleTest
{
    ...
    */
    ...
    public void GivenValidCorners_WhenConstructingRectangle_ThenSetsProperties()
    {
        ...
        var drawerMock = new MockShapeDrawer();
        var rect = new BattleStars.Domain.Entities.Shapes.Rectangle(v1, v2, color, drawerMock);
    ...
    public void GivenNullDrawer_WhenConstructing_ThenThrowsNullArgumentException()
    {
        ...
        Action act = () => new BattleStars.Domain.Entities.Shapes.Rectangle(v1, v2, Color.Red, null!);
    ...
    */
    ...
    public void GivenRectangle_WhenTestingContains_ThenReturnsExpected(float pointX, float pointY, bool expected)
    {
        ...
        var drawerMock = new MockShapeDrawer();
        var rect = new BattleStars.Domain.Entities.Shapes.Rectangle(vec1, vec2, Color.Red, drawerMock);
    ...
    */
    ...
    public void GivenRectangle_WhenDrawCalled_ThenDrawerIsCalled()
    {
        ...
        var rect = new BattleStars.Domain.Entities.Shapes.Rectangle(PositionalVector2.Zero, new PositionalVector2(2, 2), Color.Red, drawer);
