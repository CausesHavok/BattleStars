...
public class EnemyControllerTest
{
    ...
    public void GivenEnemies_WhenUpdateEnemies_ThenAllEnemiesMoveAndShoot()
    {
        ...
        enemyMock1.Setup(e => e.Shoot(contextMock.Object)).Returns(new List<IShot> { noOpShot1 });
        enemyMock2.Setup(e => e.Shoot(contextMock.Object)).Returns(new List<IShot> { noOpShot2 });
        ...
        // Then
        enemyMock1.Verify(e => e.Move(contextMock.Object), Times.Once);
        enemyMock2.Verify(e => e.Move(contextMock.Object), Times.Once);
        enemyMock1.Verify(e => e.Shoot(contextMock.Object), Times.Once);
        enemyMock2.Verify(e => e.Shoot(contextMock.Object), Times.Once);
    ...
    public void GivenEnemiesShootNull_WhenUpdateEnemies_ThenNoShotsAreAdded()
    {
        ...
        enemyMock.Setup(e => e.Shoot(contextMock.Object)).Returns((IEnumerable<IShot>)null!);
        ...
        // Then
        enemyMock.Verify(e => e.Move(contextMock.Object), Times.Once);
        enemyMock.Verify(e => e.Shoot(contextMock.Object), Times.Once);
